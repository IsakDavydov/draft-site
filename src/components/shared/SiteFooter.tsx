        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 text-sm mb-4">
              Your comprehensive source for NFL analysis, fantasy insights, draft coverage, and betting analysis.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/season" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Season
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/picks" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Picks
                </Link>
              </li>
              <li>
                <Link href="/fantasy" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Fantasy
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 SAKFootball. All rights reserved.
            </p>
