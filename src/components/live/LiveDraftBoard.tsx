  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-4">
        ...
        {totalPicks === 32 && (
          <div className="rounded-2xl bg-green-900/20 border border-green-800/30 px-5 py-4 flex items-center gap-3">
            <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0" />
            <p className="text-sm font-semibold text-green-300">Round 1 Complete — All 32 picks are in!</p>
          </div>
        )}
