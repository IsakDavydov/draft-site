...
export default function PredictionNotFound() {
  return (
    <div className="min-h-screen bg-cream-deep px-4 py-16 text-center">
      ...
      <Link
        href="/leaderboard"
        className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-rose-500 hover:underline"
      >
