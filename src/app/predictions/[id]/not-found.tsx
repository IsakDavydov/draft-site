...
export default function PredictionNotFound() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-sak-darker to-sak-darker px-4 py-16 text-center">
      <h1 className="text-xl font-bold text-white">Mock draft not available</h1>
