    ...
    <div className="min-h-screen bg-cream">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          <Link
            href="/groups"
            className="group inline-flex items-center gap-2 text-sm font-medium text-gray-500 transition-all duration-200 hover:text-rose-500"
          >
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/leaderboard"
              className="inline-flex items-center gap-2 text-sm font-medium text-rose-500 transition-colors hover:text-rose-600"
            >
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-rose-50 ring-1 ring-rose-200 shadow-sm">
          ...
          <>
            ...
            {showPreDraft ? (
              ...
              <div className="rounded-3xl border border-gray-200 bg-white p-10 text-center shadow-sm">
                ...
                <Link href="/predict" className="mt-4 inline-block font-medium text-rose-500 transition-colors hover:text-rose-500/90">
            ...
            {(showPreDraft || showMembersOnly) && (
              <p className="mt-4 text-sm text-gray-400">
                <Link href="/predict" className="text-rose-500 font-medium hover:underline">
                  Submit your predictions →
                </Link>{' '}
