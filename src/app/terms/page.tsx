      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-sak-card rounded-2xl shadow-card border border-white/[0.06] overflow-hidden">
          ...
          <div className="px-8 py-8 sm:px-10 space-y-8 text-gray-400 text-[15px] leading-relaxed">
            ...
            <section>
              <h2 className="text-base font-bold text-white mb-3">1. Eligibility & Account</h2>
            ...
            <section>
              <h2 className="text-base font-bold text-white mb-3">3. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-base font-bold text-white mb-3">4. Draft Prediction Contest</h2>
              <p>
                Participation in the draft prediction contest is subject to our{' '}
                <Link href="/contest-rules" className="text-brand-red hover:underline">Contest Rules</Link>, which are
            ...
            <section>
              <h2 className="text-base font-bold text-white mb-3">6. User Content</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-white mb-3">7. Third-Party Links & Services</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-white mb-3">13. Changes to Terms</h2>
              <p>
