  ...
  return (
    <div className="bg-cream-deep">
      <article className="mx-auto max-w-3xl px-6 py-16 sm:py-24 lg:px-8">
        <Link
          href="/articles"
          className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-rose-500 mb-8 transition-colors"
        >
        ...
        {article.format === 'mock-draft' ? (
          ...
          <div className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-rose-500 prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 prose-code:text-rose-500 prose-code:bg-gray-100 prose-code:px-1 prose-code:py-0.5 prose-code:rounded [&_p]:text-gray-700 [&_li]:text-gray-700">
